...
namespace DapperDemo.Controllers
{
    public class CompaniesController : Controller
    {
        ...
        public CompaniesController(ICompanyRepository companyRepopsitory)
        {
            _companyRepository = companyRepopsitory;
        }
        ...
        {
          return (_companyRepository.GetAll()?.Any(e => e.CompanyId == id)).GetValueOrDefault();
        }
    }
}
